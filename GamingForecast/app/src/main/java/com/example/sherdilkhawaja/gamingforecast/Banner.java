...
public class Banner extends MainActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameList.add(new Product(1, "Bloodborne: The Old Hunters", "11/03/2015", "PS4", "1"));
        gameList.add(new Product(2, "Kingdom Hearts III", "10/27/2015", "PS4/XBox 1", "2"));
        gameList.add(new Product(3, "Final Fantasy XV", "10/28/2015", "PS4", "3"));
        gameList.add(new Product(4, "Metal Gear Solid V", "10/29/2015", "PS4", "4"));
        gameList.add(new Product(5, "Pokemon Rainbow", "10/30/2016", "3DS", "5"));
        gameList.add(new Product(6, "Call of Duty: Black Ops III", "10/31/2015", "PS4/Xbox 1", "3"));
        gameList.add(new Product(7, "Destiny: The Taken King", "11/01/2015", "PS4/PC", "2"));
        gameList.add(new Product(8, "Fallout 4", "11/02/2015", "PS4/Xbox 1/PC", "1"));
